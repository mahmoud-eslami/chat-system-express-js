...
module.exports = (app) => {
    ...
    app.get("/group/search", tokenChecker, group.searchGroup);
    app.post("/group/pin/message", tokenChecker, group.pinMessage);
    app.post("/group/unpin/message", tokenChecker, group.unpinMessage);
};